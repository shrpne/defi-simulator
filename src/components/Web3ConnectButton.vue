...
<template>
    <div>
        <button v-if="!connectedWallet" @click="connect()" class="button">
        ...
        <div v-else class="flex items-center gap-4">
            ...
            <button @click="disconnect()" class="button">Disconnect</button>
        </div>
        <button v-if="connectedWallet && connectedChain?.id !== '0x1'" @click="switchChain">Switch to Ethereum Mainnet</button>
